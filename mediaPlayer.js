  class CustomVideoPlayer {
            ...
            setupEventListeners() {
                ...
                // Mouse events for auto-hide controls
            ...
            handleKeyboard(e) {
                // Only handle keyboard shortcuts when video container is focused or hovered
                if (!this.container.matches(':hover') && document.activeElement !== this.video) {
                    return;
                }
