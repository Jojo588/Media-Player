class CustomVideoPlayer {
    ...
    centerVideoIfNeeded() {
        ...
        const scaledVideoHeight = containerWidth / aspectRatio;

        if (scaledVideoHeight < containerHeight) {
            this.container.classList.add('center-vertically');
        } else {
            this.container.classList.remove('center-vertically');
        }
    }
