class CustomVideoPlayer {
    ...
    // center video
        ...
        if (isFullscreen) {
            this.container.classList.add('fullscreen-centered');
        } else {
            this.container.classList.remove('fullscreen-centered');
        }
        }
  ...
  if (!document.fullscreenElement &&
    ...
    if (requestFullscreen) {
      requestFullscreen().then(() => this.centerVideoIfNeeded()).catch(() => {});
    }
